...
export default function Navbar() {
  ...
  return (
    <>
      <header className=" top-0 bg-white h-11 md:h-121px border-b-0 md:border md:border-solid md:border-slate-700 fixed w-full z-50">
        <div className=" z-20 relative transition-all border-b border-solid border-slate-100">
          <div className=" h-11 md:h-59px py-0 pr-3 md:pr-45px pl-4 md:pl-50px flex items-center justify-between w-full my-0 mx-auto md:max-w-1920px">
            ...
            <div className=" flex ml-auto">
              ...
              ></a>
              <a className=" hidden overflow-hidden h-8 my-0 mx-1 bg-no-repeat bg-center ml-6 w-auto indent-0 md:flex md:items-center cursor-pointer text-slate-800">
                로그인
              </a>
              <a className=" hidden overflow-hidden h-8 mt-0 mx-1 bg-no-repeat bg-center ml-6 w-auto indent-0 md:flex md:items-center cursor-pointer text-slate-800">
                회원가입
              </a>
              <a
        ...
        <div className=" fixed block overflow-hidden top-0 left-full h-full border-t-0 w-full min-h-60px z-20 md:absolute md:top-59px md:left-0 md:min-h-60px md:h-auto">
          <div className=" relative flex-col md:flex-row overflow-auto md:overflow-hidden w-full h-full min-h-full pt-52px bg-white flex md:justify-center md:h-60px md:p-0">
            ...
            <ul className=" border-t-8 border-solid border-slate-100 font-light block list-outside list-none md:flex md:items-center md:border-none before:block before:w-1 before:h-1 before:my-0 before:mr-0 before:ml-0.46875px before:bg-white">
              <li className=" relative py-0 pr-3 pl-5 list-outside list-none md:pl-2">
                <a
                  className=" flex items-center h-52px py-0 px-0.520833px cursor-pointer text-slate-900 md:h-60px md:after:block md:after:w-1 md:after:h-1 md:after:mb-14px md:after:rounded-50% md:after:bg-red-600 md:hover:border-b-4 md:hover:border-t-4 md:hover:border-solid md:hover:border-b-black md:hover:border-t-white md:duration-150"
                  href="/"
                >
                  헤지스 입어봤어요
                </a>
              ...
              <li className=" relative py-0 pr-3 pl-5 list-outside list-none md:pl-2">
                <a
                  className=" flex items-center h-52px py-0 px-0.520833px cursor-pointer text-slate-900 md:h-60px md:hover:border-b-4 md:hover:border-t-4 md:hover:border-solid md:hover:border-b-black md:hover:border-t-white md:duration-150"
                  href="/"
                >
                  EVENT
                </a>
