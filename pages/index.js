...
export default function Main({ posts }) {
  ...
  const slidesPerViewSlider = width < breakpoint ? 1 : 2;
  const slider = [
    {
      link: "/",
  ...
  // new
  const spaceBetweenNew = width < breakpoint ? 10 : 20;
  const slidesPerViewNew = width < breakpoint ? 1 : 4.5;
  ...
  // review
  const spaceBetweenReview = width < breakpoint ? 0 : 0;
  const slidesPerViewReview = width < breakpoint ? 1 : 2;
  ...
  const slidesPerViewBest = width < breakpoint ? 2 : 4.5;
        ...
        <div className=" pt-0 bg-white mt-0 mx-0 -mb-636px px-0 pb-716px min-h-full md:pt-120px md:pb-433px">
          ...
          <section className=" mb-0 md:mb-50px overflow-hidden w-full">
            <div className=" relative md:overflow-hidden">
              <Swiper
                ...
                slidesPerView={slidesPerViewSlider}
          ...
          <section className=" mb-24 md:mb-150px">
            ...
            <div className=" flex-nowrap flex">
              <Swiper
                spaceBetween={spaceBetweenNew}
                slidesPerView={slidesPerViewNew}
                onSlideChange={() => console.log("slide change")}
                onSwiper={(swiper) => console.log(swiper)}
              >
          ...
          <section className=" mb-24 md:mb-100px">
            <div className=" max-w-1920px w-full h-full my-0 mx-auto">
              ...
              <div className=" pb-10 md:pb-60px flex justify-center">
                <Swiper
                  spaceBetween={spaceBetweenReview}
          ...
          <section className=" mb-24 md:mb-150px">
            <div className=" max-w-1920px w-full h-full my-0 mx-auto">
              ...
              <div className=" flex-nowrap pt-0 px-0 pb-5 flex md:my-0 md:-mx-10px">
                <Swiper
                  modules={[Navigation]}
                  spaceBetween={spaceBetweenBest}
                  slidesPerView={slidesPerViewBest}
                  navigation
                  onSlideChange={() => console.log("slide change")}
                  onSwiper={(swiper) => console.log(swiper)}
                >
